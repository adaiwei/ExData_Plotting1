...
par(mfrow = c(2,2))
plot(sub_data$NewDate, sub_data$Global_active_power, type = "l", xlab = "", ylab = "Global Active Power")
lines(sub_data$NewDate, sub_data$Voltage)
plot(sub_data$NewDate, sub_data$Voltage, type = "l", xlab = "datetime", ylab = "Voltage")
...
lines(sub_data$NewDate, sub_data$Global_reactive_power)
plot(sub_data$NewDate, sub_data$Global_reactive_power, type = "l", xlab = "datetime", ylab = "Global_reactive_power")
